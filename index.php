...
<html lang='ms-MY' data-bs-theme='dark'>
  ...
  <body>
    ...
    <header class='navbar navbar-expand-md bg-body-tertiary'>
      <div class='container'>
        <a class='navbar-brand fs-3 text-danger' href='https://www.roipdarulaman.com'><img class='img-fluid d-inline-block' src='media/favicon/favicon-96x96.png' width='25'> RoIPDARULAMAN</a>
    ...
    <main class='container text-center my-3'>
      <img class='img-fluid rounded-3 opacity-75 w-75' src='media/image/roipda_banner.png'>
      <div class='row'>
        <div class='col-12'>
