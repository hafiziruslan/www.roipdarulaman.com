      ...
      <div class='container'>
        <div class='row my-2'>
          <div class='col-lg-8 mx-auto my-1 text-md-start'>
            ...
            <p class='my-1 text-center'>Kami juga menerima <a class='link-primary' href='#' onClick='DonateWindow=window.open("//payment.tngdigital.com.my/sc/bDLnBmDoDq", "TNGD RoIPMARS Donation", "width=800,height=600"); return false;'>TnG eWallet</a> | <a class='link-primary' href='#' onClick='DonateWindow=window.open("//toyyibpay.com/sumbanganroipmars", "FPX Donation", "width=800,height=600"); return false;'>FPX MY Banks</a> | <a class='link-primary' href='#' onClick='DonateWindow=window.open("//donate.stripe.com/5kA8AceIg7Gegbm5kk", "Stripe Donation", "width=800,height=600"); return false;'>Debit/Kredit Kad</a></p>
          </div>
                ...
                <div class='modal-content'>
                  <div class='modal-body'>
                    <div class='ratio ratio-1x1'>
                      <iframe src='//1306b3f7.sibforms.com/serve/MUIEAIR2UxOW8JezeVtN05wHT8tqVrcROKOSDLHHB5BNy1LHST-CbEPqTvRhQe5_CrrvOOmbedVNkoHAJxlEwQ8tbScw_7eHtjByIUNLUHOsQBo7rmMribZ9ZpPLC89V-9lSyMybFpSBE8ClRHD6itpcxnb_bpZk-06g7sjz4NaQn2gIAlL_0HNtA_BA7UvZT5jIptMIZetcXcSB'></iframe>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class='row my-2 d-flex align-items-center'>
          <div class='col-md-9'>
          <p class='text-md-start font-monospace user-select-none text-break'><a href='../../policies' class='text-reset text-decoration-none pe-auto'>Polisi Perkhidmatan</a><span class='text-body-tertiary'> &#124; <i class='fa-solid fa-code'></i> <i class='fa-brands fa-github'></i> <i class='fa-brands fa-php'></i> <i class='fa-brands fa-html5'></i> <i class='fa-brands fa-css3'></i> <i class='fa-brands fa-square-js'></i> <i class='fa-brands fa-bootstrap'></i> <i class='fa-brands fa-font-awesome'></i><br><?php date_default_timezone_get(); $fileindir = filemtime(scandir(__DIR__)[0]); function getVisitorIp() { if (!empty($_SERVER['HTTP_X_FORWARDED_FOR'])) { $ipAdress = $_SERVER['HTTP_X_FORWARDED_FOR'] . ' dari ' . $_SERVER['HTTP_CF_IPCITY'] . ', ' . $_SERVER['HTTP_CF_IPCOUNTRY']; } else { $ipAdress = $_SERVER['//api64.ipify.org']; } return $ipAdress; } echo 'Kemaskini: ' . date('d/m/Y, h:i A', $fileindir) . ' &#124; IP Anda: ' . getVisitorIp(); ?><br><i class='bi-c-circle'></i> 2020&ndash;<script>document.write(new Date().getFullYear())</script> Hak Cipta Terpelihara. ROIPMARS&trade; &#124; PERSATUAN PEMINAT RADIO KOMUNIKASI PPM-006-10-01062020</span></p>
          </div>
          <div class='col-md-3 ml-lg-0 mb-3'>
            <div class='text-md-end'>
              <a class='text-reset text-decoration-none' href='//www.facebook.com/groups/240269310577618/'><i class='fa-brands fa-facebook-f h1 mx-1 my-0' style='color: #17A9FD'></i></a>
              <a class='text-reset text-decoration-none' href='//fb.com/roipmars.org.my'><i class='bi-facebook h1 mx-1' style='color: #0165E1'></i></a>
              <a class='text-reset text-decoration-none' href='//t.me/marsts3servercyberjaya'><i class='bi-telegram h1 mx-1' style='color: #0088cc'></i></a>
              <a class='text-reset text-decoration-none' href='//wa.me/c/60333960874'><i class='bi-whatsapp h1 mx-1' style='color: #25D366'></i></a>
              <a class='text-reset text-decoration-none' href='#' onClick='TSLoginWindow=window.open("//www.roipmars.org.my/applogin", "Login RoIPMARS Comm Apps", "width=800,height=600"); return false;'><i class='bi-headset h1 mx-1'></i></a>
            </div>
          </div>
        </div>
      </div>
