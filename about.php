          ...
          <ul class='timeline'>
            ...
            <li>
              <div class='direction-l'>
                <div class='flag-wrapper'>
                  <span class='hexa'></span>
                  <span class='flag'>Penguatkuasaan penggunaan tanda panggilan jalur rakyat</span>
                  <span class='time-wrapper'><span class='time'>1 Mac 2020</span></span>
                </div>
                <div class='desc'>Bertepatan dengan perolehan pelayan dengan bantuan 9W2UZL &amp; 9W2LGX, pengguna roipdarulaman diminta untuk memohon tanda panggilan jalur rakyat untuk digunakan semasa komunikasi untuk membantu peminat radio komunikasi belajar berkomunikasi menggunakan radio dengan betul dan efisien.</div>
              </div>
            </li>
            <li>
              <div class='direction-l'>
            ...
            <li>
              <div class='direction-l'>
                <div class='flag-wrapper'>
                  <span class='hexa'></span>
                  <span class='flag'>Perolehan pelayan</span>
                  <span class='time-wrapper'><span class='time'>10 Januari 2020</span></span>
                </div>
                <div class='desc'>Beralih dari saluran CB ke pelayan sendiri yang didaftarkan dengan nama roipdarulaman.com</div>
              </div>
            </li>
            <li>
              <div class='direction-r'>
                <div class='flag-wrapper'>
                  ...
                  <span class='time-wrapper'><span class='time'>Oktober 2019</span></span>
                </div>
